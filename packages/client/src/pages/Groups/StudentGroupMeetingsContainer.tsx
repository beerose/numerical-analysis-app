...
type StudentGroupMeetingsContainerProps = {};
export const StudentGroupMeetingsContainer: React.FC<
  StudentGroupMeetingsContainerProps
> = () => {
  ...
  return (
    <PaddingContainer>
      <Breadcrumbs css={{ marginBottom: theme.Padding.Half }} />
